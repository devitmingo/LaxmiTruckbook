                                 ...
                                 <a href="{{ route('driver.index') }}"><button  type="button" class="btn btn-primary right">  Show Driver </button></a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                @if(isset($data))
                                                <form action="{{ route('driver.update',$data->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                                @method('PATCH')
                                                @else
                                                <form action="{{ route('driver.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                                @endif
                                                    @csrf
                                                    <div class="row g-2">
