                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card">
                                  ...
                                  <a href="{{ route('kinpin.index') }}"><button  type="button" class="btn btn-primary right">Kinpin Report</button></a>
                                        <br>
                                        </br>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                @if(isset($data))
                                                <form action="{{ route('kinpin.update',$data->id) }}" method="post">
                                                @method('PATCH')
                                                @else
                                                <form action="{{ route('kinpin.store') }}" method="post">
                                                @endif
                                                    @csrf
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="mb-3 col-md-3">
                                                             <label for="inputPassword4" class="form-label">Front-1</label>
                                                             <input type="text" class="form-control" name="front_1" id="front_1" value="{{ old('front_1',isset($data->front_1) ? $data->front_1 : '' )}}">
                                                        </div>

                                                        <div class="mb-3 col-md-3">
                                                             <label for="inputPassword4" class="form-label">Front-2</label>
                                                             <input type="text" class="form-control" name="front_2" id="front_2" value="{{ old('front_2',isset($data->front_2) ? $data->front_2 : '' )}}">
                                                        </div>
                                                        <div class="mb-3 col-md-3">
