                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add Maintenance</h4>  
                                </div>
                                </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                @if(isset($data))
                                                <form action="{{ route('maintenance.update',$data->id) }}" method="post" autocomplete="off">
                                                @method('PATCH')
                                                @else
                                                <form action="{{ route('maintenance.store') }}" method="post" autocomplete="off">
                                                @endif
                                                    @csrf
                                                    <div class="row g-2">
                                                          ...
                                                          <div class="mb-3 col-md-3">
                                                            <label for="inputPassword4" class="form-label">Maintenance Name<span class="imp">*</span></label>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{{route('maintenance.edit',$row->id)}}" class="btn btn-success" rel="tooltip" title="Edit">
                                                                    <i class="mdi mdi-square-edit-outline"></i>
                                                                </a>
                                                                <!-- <a href="#" class="btn" rel="tooltip" title="Delete">
                                                                
                                                                <form action="{{route('maintenance.destroy',$row->id)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
