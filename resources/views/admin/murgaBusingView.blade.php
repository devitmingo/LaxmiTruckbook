  ...
  <!-- start page title -->
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Murga Busing Report</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{ route('murgaBusing.create') }}"><button  type="button" class="btn btn-primary right"> + Add Murga Busing</button></a>
                                        <br>
                                        </br>
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ isset($vendorName) ? $vendorName : '' }}</td>
                                                             ...
                                                             <td>
                                                             <a href="{{route('murgaBusing.edit',$row->id)}}" class="btn btn-success" rel="tooltip" title="Edit">
                                                                    <i class="mdi mdi-square-edit-outline"></i>
                                                                </a>
                                                                <a href="#" class="btn" rel="tooltip" title="Delete">
                                                                
                                                                <form action="{{route('murgaBusing.destroy',$row->id)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
