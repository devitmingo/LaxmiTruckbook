                                           ...
                                           @csrf
                                            <div class="tab-content">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    @endphp
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="number" name="payment[]" value="0" class="form-control" onchange="totalSum(this.value)" /></td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="col-md-12">
                                                            <input  type="text" class="form-control datepicker" id="datepicker"  name="paymentDate">
                                                        </div>
                                                        ...
                                                        <div class="col-md-12" style="float:right; margin-top:12px;">
                                                        <button class="btn btn-primary pull-right" style="float:right;">Save</button> 
                                                        </div> <!-- end preview-->
                                                    </div>
                                            </div> <!-- end tab-content-->
                                        </form>
