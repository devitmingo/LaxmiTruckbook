                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                @if(isset($data))
                                                <form action="{{ route('state.update',$data->id) }}" method="post" autocomplete="off">
                                                @method('PATCH')
                                                @else
                                                <form action="{{ route('state.store') }}" method="post" autocomplete="off">
                                                @endif
                                                    @csrf
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="mb-3 col-md-3">
                                                            ...
                                                            <script>document.getElementById("statu1").value = "{{ old('status',isset($data->status) ? $data->status : '1' )}}"; </script>
                                                        </div>
                                                         <div class="mb-3 col-md-3">
                                                         </br>   
