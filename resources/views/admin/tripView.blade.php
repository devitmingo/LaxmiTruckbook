                                        ...
                                        <div class="step-item current">
                                            <span data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" > 
                                                @if(isset($data->endDate)) 
                                                    <button class="btn btn-primary" onclick="onComplete()"><i class="mdi mdi-square-edit-outline"></i></button>
                                                @endif  
                                                Completed {{ isset($data->endDate) ? "on ".date('d-m-Y',strtotime($data->endDate)) : '' }}</span>
                                        </div>
                                        <div class="step-item current">
                                            <span>
                                            @if(isset($data->pod_receuve_date)) 
                                                    <button class="btn btn-primary" onclick="onPODReceive()"><i class="mdi mdi-square-edit-outline"></i></button>
                                            @endif

                                            POD Received {{ isset($data->pod_receuve_date) ? date('d-m-Y',strtotime($data->pod_receuve_date)) : '' }}</span>
                                        </div>

                                        <div class="step-item current">
                                            <span>
                                            @if(isset($data->pod_submitted_date)) 
                                                    <button class="btn btn-primary" onclick="onPODSubmit()"><i class="mdi mdi-square-edit-outline"></i></button>
                                            @endif

                                            POD Submited {{ isset($data->pod_submitted_date) ? date('d-m-Y',strtotime($data->pod_submitted_date)) : '' }}</span>
                                        </div>
                                        <div class="step-item current">
                                        <span>
                                            @if(isset($data->settelement_date)) 
                                                    <button class="btn btn-primary" onclick="partyPaymentModel()"><i class="mdi mdi-square-edit-outline"></i></button>
                                            @endif
                                            Settlement {{ isset($data->settelement_date) ? date('d-m-Y',strtotime($data->settelement_date)) : '' }}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th>{{ AdminController::getValueStatic2('vehicles','vehicleNumber','id',$data->vehicleNumber) }} </br>{{ AdminController::getValueStatic2('drivers','driverName','id',$data->supplierName) }} </th>
                                                    @endif
                                                </tr>
                                                </thead>
                                ...
                                <div class="card" style="display:none;">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" >
                                        <div class="">
                                         <button style="display:none;"  type="button" class="btn btn-primary" onclick="expensesModel()"><i class="mdi mdi-truck-fast h2 text-muted"></i>
                                         ...
                                         <button  type="button" class="btn btn-primary" onclick="partyChargeModel()"><i class="mdi mdi-truck-fast h2 text-muted"></i>
                                            ...
                                            <h5><b>Supplier </br> Transations</b></h5></button>
                                            @endif
                                             &nbsp
                                            <button style="display:none;" type="button" class="btn btn-primary" onclick="partyAdvanceModel()"><i class="mdi mdi-truck-fast h2 text-muted"></i>
                                            <h5><b> Party </br> Advance</b></h5></button>
                                            
                                            @if($ownership == 'Market Truck')
                                            &nbsp
                                            <button style="display:none;" type="button" class="btn btn-primary" onclick="supplierAdvanceModel()"><i class="mdi mdi-truck-fast h2 text-muted"></i>
                                            ...
                                            @if($ownership == 'Market Truck')
                                            &nbsp
                                            <button  style="display:none;" type="button" class="btn btn-primary" onclick="supplierPaymentModel()"><i class="mdi mdi-truck-fast h2 text-muted"></i>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body px-4 pb-4 pt-0">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="control-label form-label">Payment Type <a href="#"><i class="mdi mdi-plus-box" style="font-size:20px;" onclick="addpaymentTypeModel()"></i></a></label>
                                                            <select class="form-select fetchPaymentType" name="payType" id="payType" >
...
<div class="modal fade m-5" id="addAdvanceTypeModel" tabindex="-1" role="dialog" aria-labelledby="addAdvanceTypeModel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body px-4 pb-4 pt-0">
                                                ...
                                                <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="control-label form-label">Expenses Type <a href="#" onclick="AddExpenses();">+</a></label>
