                                            ...
                                            <div class="tab-pane show active" id="buttons-table-preview">
                                                <table  id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Loading Date=>Unloading Date</th>
                                                            <th>From=>To</th>
                                                            <th>Material</th>
                                                            <th>Loading Weight</th>
                                                            <th>Unloding Weight</th>
                                                            <th>Rate</th>
                                                            <th>Total Amount</th>
                                                ...
                                                @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ date('d-m-Y',strtotime($row->startDate)) }} => {{ date('d-m-Y',strtotime($row->endDate)) }}</td>
                                                            <td>{{ isset($origin) ? $origin : '' }} => {{ isset($destination) ? $destination : '' }}  </td>
                                                            <td>{{ isset($material) ? $material : '' }}  </td>
                                                            <td>{{ isset($loadig_weight) ? $loadig_weight : '' }}  </td>
                                                            <td>{{ isset($unloading_weight) ? $unloading_weight : '' }}  </td>
                                                            <td>{{ isset($rate) ? $rate : '' }}  </td>
                                                            <td>{{ isset($loadig_weight) ? $loadig_weight * $rate : '' }}  </td>
                                                            <td>{{ isset($diesel_adv_transport) ? "₹"."₹".number_format($diesel_adv_transport,2) : ''  }}</td>
                                                            <td>{{ isset($driver_cash_transport) ? "₹"."₹".number_format($driver_cash_transport,2) : ''  }}</td>
                                                            <td>{{ isset($shortage_amount) ? "₹"."₹".number_format($shortage_amount,2) : ''  }}</td>
                                                            <td>{{ isset($extra_diesel_amout) ? "₹".number_format($extra_diesel_amout,2) : ''  }}</td>
                                                            <td>{{ isset($extra_expenses) ? "₹".number_format($extra_expenses,2) : ''  }}</td>
                                                            <td>{{ isset($builty_commission) ? "₹".number_format($builty_commission,2) : ''  }}</td>
                                                            <td>{{ isset($toll_amount) ? "₹".number_format($toll_amount,2) : ''  }}</td>
