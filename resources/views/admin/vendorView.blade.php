  ...
  <!-- start page title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{ route('vendor.create') }}"><button  type="button" class="btn btn-primary right"> + Add Vendor</button></a>
                                        <br>
                                        </br>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $row->mobile }}</td>
                                                            <td>{{ isset($row->mobile2) ? $row->mobile2 : '' }}</td>
                                                            <td>{{ isset($row->address) ? $row->address : '' }}</td>
                                                            <td>@if($row->status==1)  Enable @else Disable  @endif </td>
                                                             <td><a href="{{route('vendor.edit',$row->id)}}" class="btn btn-success" rel="tooltip" title="Edit">
